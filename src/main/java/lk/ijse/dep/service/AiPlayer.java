...
public class AiPlayer extends Player {
    ...
    public void movePiece(int col) {
       /*do {
        ...
        if(board.isLegalMove(col)){
            ...
            System.out.println(board.findWinner());//debugging print winner
        }
    }
    static class Mcts{
        ...
        //Scale up the tree via creating child nodes by dividing the parent node
    ...
    static class Node {
        ...
        //return the highest valued child (AI won +1 ; fail -1)
